# -*- coding: utf-8 -*-
#
# Wiser documentation build configuration file, created by
# sphinx-quickstart on Tue May 28 14:24:17 2013.
#
...
# of the sidebar.
#html_logo = 'Z_SharedFiles//mosy.png'
...
man_pages = [
    ('index', 'Wiser', u'Wiser Documentation',
     [u'Fernanda Nery'], 1)
]
...
texinfo_documents = [
  ('index', 'Wiser', u'Wiser Documentation',
   u'Fernanda Nery', 'Wiser', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Wiser'
epub_author = u'Fernanda Nery'
epub_publisher = u'Fernanda Nery'
epub_copyright = u'2014, Fernanda Nery'
